...
async def start_message(app, message):
    ...
    text = f"Hi {message.from_user.mention()}<a href='https://t.me/bosshubots'>!</a> I'm VideoEncoder Bot which will do magic with your file."
...
Supports: <a href='https://t.me/bosshubots'>click here</a>"""
